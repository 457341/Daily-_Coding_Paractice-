...
# Write a Python program that accept name of given subject and marks. Input number of subjects in first line and subject name, 
# marks separated by a space in next line.Print subject name and marks in order of its first occurrence.
